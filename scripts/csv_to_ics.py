...
"""
    ...
    for row in events:
        ...
        # ICE CUT detection (desc contains "takedown", duration <= 20)
        is_ice_cut = ("takedown" in desc_lower) and (duration_minutes <= 20)
...
"""
        ...
        # Color coding (ICE CUT overrides to gray)
        if is_ice_cut:
...
def csv_to_ics(csv_path):
    ...
    for r in all_rows:
        ...
        if "takedown" in desc and duration <= 20:
